...
Monad Rank Rush 是一个面向 Web3 新人的高频互动小游戏概念。用户连接钱包后，可以参与 30 秒挑战，获得分数并进入排行榜。游戏过程不需要全部上链，但最终成绩、任务完成记录、奖励领取和赛季徽章可以记录到链上，用于公开验证和身份展示。项目希望结合 Monad 的低延迟和高性能特点，让链上交互更接近普通消费级 App 的体验。同时，通过好友反超、排行榜竞争、Meme 战绩图和赛季身份，鼓励用户分享、邀请朋友和持续参与。这个项目重点不是复杂金融逻辑，而是探索 Consumer Crypto 中更轻量、更有社交传播性的链上互动场景。

## 3. 测试邀请文案

我们正在测试一个 Monad 高频互动小游戏概念：**Monad Rank Rush**。

它是一个 30 秒挑战类小游戏，用户可以完成挑战、获得分数、查看排行榜、领取徽章，并生成一张可以分享的 Meme 战绩图。

这次测试不需要你真的完成复杂链上操作，我们更想了解：\
你是否能看懂这个产品想做什么？\
你是否愿意参与这样的挑战？\
排行榜、徽章、Meme 图有没有让你想分享或邀请朋友？

如果你对 Web3、Monad、小游戏、排行榜或社区活动感兴趣，欢迎花 5–10 分钟帮我们体验概念并反馈。

## 4. 用户测试任务

请用户完成以下测试任务：

1. 阅读 Monad Rank Rush 的项目介绍。
2. 想象自己正在参与一个 30 秒小游戏挑战。
3. 查看项目流程：连接钱包 → 开始挑战 → 获得分数 → 查看排行榜 → 领取徽章 → 分享战绩图。
4. 判断哪些环节你觉得有吸引力，哪些环节不清楚。
5. 回答下面 3–5 个反馈问题。

## 5. 反馈问题

1. 你能不能在 1 分钟内理解 Monad Rank Rush 是什么？
2. 你觉得“30 秒挑战 + 排行榜 + 徽章”的玩法有吸引力吗？为什么？
3. 如果你被好友超过排名，你会想再挑战一次吗？
4. Meme 战绩图会不会让你更愿意分享到社群或朋友圈？
5. 你觉得哪些数据应该上链：最终成绩、排行榜、徽章、奖励领取，还是都没必要？

## 6. 项目介绍页 / Landing Page 草稿

# Monad Rank Rush

## 30 秒冲榜，把你的战绩留在 Monad 上

Monad Rank Rush 是一个轻量级链上社交小游戏。\
完成挑战，刷新排行榜，领取徽章，生成你的 Meme 战绩图。

### 核心玩法

**Play**\
进入 30 秒小游戏挑战，获得即时分数反馈。

**Rank**\
提交最终成绩，查看全站榜、好友榜和赛季榜。

**Badge**\
完成任务后领取徽章，例如 Top 100 Survivor、Monad Tap King、Daily Grinder。

**Share**\
生成 Meme 战绩图，把你的胜利、失败或被反超瞬间分享到社群。

### 为什么用 Monad？

这个产品需要频繁互动和快速反馈。\
如果每次挑战、排名更新和奖励领取都很慢，用户体验会被打断。Monad 的高性能和低延迟更适合承载这类高频 Consumer Crypto 场景。

### 哪些内容上链？

不是所有点击都上链。\
游戏过程、动画和临时分数可以放在链下。\
最终成绩、任务完成、奖励领取、赛季徽章等更适合上链，因为它们涉及公开验证、排行榜竞争和用户身份。
...
* Monad 生态新人
* 喜欢社交挑战和 Meme 图的社区成员
* 想体验轻量 Consumer Crypto 产品的 Builder
