...
ui真的好难做，共学营结束之后有必要系统性学习一下。。。\
先学会Figma。现在问题就是有想法、有审美，但是很难落实在前端上，ai辅助总是差点意思，自己掌握设计工具效率会提高不少。\
ai只能做出来不丑、功能齐全、交互流畅的网页，但再上一个阶层，想要一些艺术性的视觉表达，再多素材+提示词往往也很难达到我个人化、特殊化的要求，自己掌握工具的话应该可以让网页变成一个艺术作品，更有艺术品位一些。。
