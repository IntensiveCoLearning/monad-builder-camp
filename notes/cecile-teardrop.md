...
[https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week3/722.md](https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week3/722.md)
...
-   AgentNFT 合约编写 — 纯手写 ERC-721，无外部依赖
    
-   Agent 属性设计 — strength / speed / strategy / defense / luck
    
-   Mint 机制 — 伪随机属性生成（范围 40-80）
    
-   经验值与升级系统 — addExperience + 自动升级
    
-   授权合约机制 — 只有 Arena 可为 NFT 加经验
    

合约：[https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/AgentNFT.sol](https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/AgentNFT.sol)  
**Arena 三合约集成联调**

-   Arena 合约编写 — 集成 ScoreLeaderboard + AgentNFT + BattleEngine
    
-   createBattle/joinBattle 绑定 NFT — 验证持有者
    
-   对战结果 → NFT 经验值 — 胜 +50 / 败 +10 / 平 +20
    
-   对战结果 → 排行榜里程碑 — Battle Win / Draw / Streak
    
-   编译测试通过 — 19806 chars, 26 函数, 7 事件
    
-   README 编写 — 完整 Remix 部署流程
    

合约：[https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/Arena.sol](https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/Arena.sol)  
readme：[https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/Arena-README.md](https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/Arena-README.md)
...
合约：[https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/BattleEngine.sol](https://github.com/cecile-teardrop/-Monad-Buidler-Camp2026-7/blob/week2/BattleEngine.sol)
