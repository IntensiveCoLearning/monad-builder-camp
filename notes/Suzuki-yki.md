...
我其实一开始不太了解research主要是干嘛的，现在理解了reserach也需要了解很多区块链相关的知识才能去分析项目的可行性，例如

### **1.Protocol Researcher（协议研究员）：**
