...
今天还没顾上配置钱包,先蹲了 DevRel 那场分享,也跟了一部分 co-learning 的内容。DevRel 那场印象比较深的一点是，其实不用一上来就逼自己想清楚"我要走技术路线还是别的",先学、先看,方向是慢慢摸出来的。钱包配置和 Testnet 这部分还没开始,打算今晚尽快补上,再往后面的任务推进。
