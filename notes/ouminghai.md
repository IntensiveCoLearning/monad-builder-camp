...
# 完成 MOSS 的 PR：[https://github.com/nishuzumi/moss/pull/33](https://github.com/nishuzumi/moss/pull/33)
...
1.登链社区学习课程：[https://learnblockchain.cn/article/22566?course\_id=93](https://learnblockchain.cn/article/22566?course_id=93) solidity 语法

2.了解 LangChian 和 LangGraph 框架

3.[https://github.com/mattpocock/skills/tree/main](https://github.com/mattpocock/skills/tree/main)
...
深入理解 REACT 和 nextjs 框架

深入学习[https://www.wtf.academy/zh/course/solidity101/HelloWeb3](https://www.wtf.academy/zh/course/solidity101/HelloWeb3) 学习 solidity 语法
...
# 0X0 通过教程及 chatgpt 学习 solidity 相关语法

# 0X1 学习 nextjs react 相关前端语法及调用钱包的框架
...
### 深入了解 solidity 语法和理解合约与 部署在EVM 的表现形式
